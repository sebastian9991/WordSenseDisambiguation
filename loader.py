...
class WSDInstance:
    def __init__(self, my_id, lemma, context, pos, index):
        self.id = my_id         # id of the WSD instance
        self.lemma = lemma      # lemma of the word whose sense is to be resolved
        self.context = context  # lemma of all the words in the sentential context
        self.pos = pos          # POS of the word whose sense is to be resolved
        ...
        for sentence in text:
            ...
            for i, el in enumerate(sentence):
                if el.tag == 'instance':
                    ...
                    pos = to_ascii(el.attrib['pos'])
                    instances[my_id] = WSDInstance(my_id, lemma, context, pos, i)
